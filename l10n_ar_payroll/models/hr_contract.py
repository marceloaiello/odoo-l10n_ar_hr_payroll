...
class HrContract(models.Model):
    ...
    """ SICOSS AFIP Fields """
    afip_situacion_revista_id = fields.Many2one(comodel_name='hr.afip.situacion_revista', string='Situacion de Revista')  # TODO: Debe ser dinamico
    ...
    afip_codigo_siniestrado_id = fields.Many2one(comodel_name='hr.afip.codigo_siniestrado', string='Codigo Siniestrado')  # TODO: Debe ser dinamico
    ...
    """ Aportes Adicionaes SS y Obra Social """
    ...
    os_contribucion_adicional = fields.Float(string='Contribucion Adicional', default="0")
